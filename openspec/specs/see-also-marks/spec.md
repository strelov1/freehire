# see-also-marks Specification

## Purpose

Resolving and rendering a circular visual mark (brand logo, country flag, or
family icon) for each card in a job page's "See also" row, given the card's
