# neogov-source Specification

## Purpose

The NEOGOV career-site source adapter (`governmentjobs.com` and its education vertical
`schooljobs.com`), used by US public colleges and school districts. Defines the board
shape, listing pagination, and the detail-fetched full description.
