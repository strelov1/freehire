# source-stats-rollup Specification

## Purpose
The measurement behind the public source catalogue: what the `source_stats` snapshot
holds, how its two job counts are taken together, and how a degraded measurement is
