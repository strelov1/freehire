# interview-debrief Specification

## Purpose

The review of an interview that has already happened, held against one application. It
exists because the most truthful account of a candidate's own work passes through the
product and was being lost: what they said out loud to an employer, under pressure, an
hour ago. A CV is an edited version of someone and a rehearsal is an improvisation; this
is neither. The session turns that recollection into evidence in the experience bank and
tells the candidate where each answer fell short.

It is the mirror of `interview-rehearsal` and shares its binding, its context and its
tools; what differs is the prompt, and one rule inside it that inverts — a rehearsal must
guard against banking an improvisation, a debrief exists to bank a recollection.
