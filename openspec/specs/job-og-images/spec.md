# job-og-images Specification

## Purpose

On-demand rendering of a per-job 1200×630 Open Graph preview image, served from a
dedicated web endpoint and populated from the job's served wire fields, with
defined graceful-degradation behaviour for missing data and logos. It gives shared
links to vacancies a visual, on-brand preview.
