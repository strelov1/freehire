...
// See internal/screeninganswers/AGENTS.md for the full boundary reasoning.
...
// to validate against here — internal/vocab documents salary_currency as a deliberately
