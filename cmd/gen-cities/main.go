...
func writeTSV(path string, places []place) error {
	...
	b.WriteString("# Regenerate with `make gen-cities`. Columns: canonical-name<TAB>country<TAB>alias|alias|...<TAB>population\n")
	b.WriteString("# Population is what lets the loader treat a small place as evidence-only: see cities.go.\n")
	for _, p := range places {
		...
		b.WriteByte('\t')
		b.WriteString(strconv.FormatInt(p.pop, 10))
		b.WriteByte('\n')
	}
