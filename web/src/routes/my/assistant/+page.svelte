<script lang="ts">
  // Thin host: the agent chat now lives in the reusable <AssistantChat> (shared with the
  // /tailor surface). This page just renders it with the session rail, honouring an optional
