...
export const SKILL_ALIASES = {
  ...
  'bash': ['bash', 'shell'],
  'bdd': ['bdd'],
  'behavior-based-safety': ['BBS', 'behavior based safety', 'behaviour based safety'],
  'bentoml': ['bentoml'],
  'bgp': ['bgp'],
  'bicep': ['bicep'],
  'bigquery': ['bigquery'],
  ...
  'concur': ['sap concur'],
  'confined-space': ['confined space', 'confined spaces'],
  ...
  'cordova': ['cordova'],
  'cority': ['cority'],
  'corrective-action': ['corrective action', 'corrective actions', 'corrective and preventive action'],
  'couchdb': ['couchdb'],
  'coupa': ['coupa'],
  'cpp': ['c++', 'c/c++'],
  'cpq': ['cpq'],
  ...
  'datadog': ['datadog'],
  'dataverse': ['dataverse'],
  'davinci-resolve': ['da vinci resolve', 'davinci resolve'],
  'db2': ['db2'],
  'dbt': ['dbt'],
  'debezium': ['debezium'],
  ...
  'ember': ['ember'],
  'emergency-response': ['emergency preparedness', 'emergency response'],
  ...
  'incident-investigation': ['incident investigation', 'incident investigations'],
  'indesign': ['indesign'],
  ...
  'jmeter': ['jmeter'],
  'jms': ['jms'],
  'job-safety-analysis': ['job hazard analysis', 'job safety analysis'],
  'jpa': ['jpa'],
  'jquery': ['jquery'],
  'json': ['json'],
  'jsp': ['jsp'],
  ...
  'near-miss-reporting': ['near miss', 'near misses'],
  'neo4j': ['neo4j'],
  'nessus': ['nessus'],
  'nestjs': ['nestjs'],
  'netsuite': ['netsuite'],
  ...
  'safety-audit': ['safety audit', 'safety audits'],
  'safety-management-system': ['ehs management system', 'hse management system', 'safety management system'],
  'sagemaker': ['sagemaker'],
  ...
  'storyboarding': ['storyboarding', 'storyboards'],
  'storybook': ['storybook'],
  ...
  'tomcat': ['tomcat'],
  'toolbox-talks': ['toolbox talk', 'toolbox talks'],
  ...
  'working-at-height': ['work at height', 'working at height'],
  'wpf': ['wpf'],
  'xamarin': ['xamarin'],
  'xcode': ['xcode'],
  'xdr': ['xdr'],
