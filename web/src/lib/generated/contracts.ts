...
export const SKILL_DESCRIBED = ['3ds-max', 'abap', 'accessibility', 'account-executive', 'accounts-receivable', 'actix', 'adp', 'agentic-ai', 'agile', 'ahrefs', 'ai', 'airbyte', 'airflow', 'alteryx', 'altium', 'amplitude', 'anaplan', 'android', 'angular', 'ansible', 'anthropic', 'api-security', 'ariba', 'artifactory', 'as400', 'asana', 'assembly', 'astro', 'athena', 'atlassian', 'aurora', 'authentication', 'autodesk-inventor', 'autogen', 'automation', 'aws', 'azure', 'azure-devops', 'backbone', 'bash', 'bdd', 'bentoml', 'bicep', 'bioinformatics', 'bitbucket', 'blender', 'blockchain', 'boolean-search', 'bpmn', 'braze', 'burp-suite', 'business-development', 'c', 'cad', 'cadence-virtuoso', 'cassandra', 'catia', 'cfd', 'chromadb', 'churnzero', 'ci-cd', 'circleci', 'cisco', 'citrix', 'civil-3d', 'claude', 'clickhouse', 'clojure', 'cloud', 'cloud-native', 'cloud-security', 'cloudformation', 'cloudwatch', 'cmake', 'cmos', 'cobol', 'cohere', 'computer-vision', 'confluence', 'containerization', 'content-marketing', 'contract-lifecycle-management', 'coupa', 'cpp', 'cpq', 'crm', 'crowdstrike', 'cryptography', 'csharp', 'css', 'cucumber', 'customer-onboarding', 'cyberark', 'cybersecurity', 'dagster', 'dart', 'dask', 'data-analytics', 'data-engineering', 'data-governance', 'data-lineage', 'data-mining', 'data-modeling', 'data-pipelines', 'data-quality', 'data-science', 'data-visualization', 'databricks', 'datadog', 'db2', 'dbt', 'debezium', 'deep-learning', 'deepspeed', 'delta-lake', 'design-patterns', 'design-thinking', 'devops', 'distributed-computing', 'distributed-systems', 'django', 'docker', 'dotnet', 'dropwizard', 'druid', 'dynamodb', 'dynatrace', 'ecommerce', 'edr', 'eks', 'elixir', 'elk', 'email-marketing', 'ember', 'employee-relations', 'employer-branding', 'entra-id', 'envoy', 'erp', 'ethereum', 'ethersjs', 'etl', 'event-driven-architecture', 'express', 'faiss', 'fastapi', 'fastify', 'fea', 'fedramp', 'fiber', 'figjam', 'figma', 'financial-reporting', 'finops', 'fintech', 'firebase', 'firmware', 'fivetran', 'fsharp', 'full-cycle-recruiting', 'fusion-360', 'game-development', 'gap-analysis', 'gatling', 'gcp', 'gemini', 'generative-ai', 'gin', 'git', 'github', 'gitlab', 'gitops', 'gke', 'go', 'go-to-market', 'gong', 'google-search-console', 'google-tag-manager', 'gradle', 'grafana', 'grails', 'groovy', 'grpc', 'hadoop', 'hapi', 'hbase', 'helm', 'hibernate', 'hive', 'hl7', 'hootsuite', 'hpc', 'html', 'hubspot', 'huggingface', 'hyper-v', 'i2c', 'iam', 'iceberg', 'illustrator', 'image-processing', 'indesign', 'infrastructure-as-code', 'invision', 'ios', 'iso-9001', 'istio', 'j2ee', 'jamf', 'java', 'javascript', 'jax', 'jboss', 'jcl', 'jdbc', 'jenkins', 'jetpack', 'jira', 'jmeter', 'jms', 'jpa', 'json', 'julia', 'juniper', 'jupyter', 'k6', 'kafka', 'kanban', 'keras', 'keycloak', 'kicad', 'kinesis', 'kotlin', 'ktor', 'kubeflow', 'kubernetes', 'kvm', 'langchain', 'langsmith', 'laravel', 'lead-generation', 'lgpd', 'linux', 'llm', 'llmops', 'looker-studio', 'lottie', 'lua', 'machine-learning', 'macos', 'mariadb', 'marketing-automation', 'marketo', 'matlab', 'maven', 'maximo', 'maya', 'mcp', 'memcached', 'meta-ads', 'metasploit', 'microservices', 'microsoft-access', 'microsoft-dynamics', 'minitab', 'miro', 'mistral', 'mixpanel', 'mlflow', 'mocha', 'mockito', 'modbus', 'mongodb', 'mqtt', 'mulesoft', 'mvc', 'mvvm', 'mysql', 'nats', 'navisworks', 'nestjs', 'netsuite', 'networking', 'neural-networks', 'newrelic', 'nextjs', 'nifi', 'nim', 'nodejs', 'nosql', 'notion', 'numpy', 'nuxt', 'oauth', 'observability', 'ocaml', 'onedrive', 'onnx', 'oop', 'opencv', 'openid', 'opensearch', 'openstack', 'oracle', 'ospf', 'peft', 'penetration-testing', 'peoplesoft', 'performance-management', 'pgvector', 'php', 'pinecone', 'playwright', 'plotly', 'podman', 'postgresql', 'postman', 'powerapps', 'powerbi', 'powershell', 'ppc', 'pre-sales', 'preact', 'predictive-analytics', 'predictive-modeling', 'prefect', 'premiere-pro', 'presto', 'process-improvement', 'process-modeling', 'program-management', 'prompt-engineering', 'prototyping', 'pulsar', 'pulumi', 'puppeteer', 'pyspark', 'python', 'pytorch', 'qgis', 'quarkus', 'r', 'rabbitmq', 'rails', 'rancher', 'react', 'react-native', 'redshift', 'redux', 'regulatory-compliance', 'reinforcement-learning', 'rest', 'revenue-recognition', 'rhel', 'robot-framework', 'ros2', 'rpa', 'rspec', 'ruby', 'rust', 'rxjs', 'saas', 'safe-agile', 'sagemaker', 'sales-engineering', 'salesforce', 'salesloft', 'sap', 'sap-s4hana', 'sas', 'sass', 'scada', 'scala', 'scikit-learn', 'scim', 'scipy', 'scrum', 'scss', 'scylladb', 'sdlc', 'sdn', 'secure-coding', 'semantic-kernel', 'semrush', 'seo', 'serverless', 'servicenow', 'sharepoint', 'shopify', 'siemens-nx', 'sinatra', 'six-sigma', 'sketchup', 'slack', 'smartsheet', 'snmp', 'snowflake', 'soc-2', 'solana', 'solarwinds', 'solidjs', 'solr', 'solution-design', 'soql', 'spacy', 'spark', 'splunk', 'spring', 'sql', 'sql-server', 'sqlite', 'ssh', 'ssis', 'ssl', 'stakeholder-management', 'stata', 'statistics', 'storybook', 'strategic-planning', 'streamlit', 'superset', 'svelte', 'swagger', 'swift', 'swiftui', 'symfony', 'systemverilog', 'tableau', 'tcl', 'tcp-ip', 'tdd', 'teamcenter', 'teamcity', 'technical-discovery', 'technical-evangelism', 'technical-writing', 'tensorrt', 'terraform', 'test-automation', 'testrail', 'threejs', 'tokenomics', 'travis', 'trello', 'trino', 'typescript', 'ubuntu', 'udp', 'uipath', 'uml', 'unity', 'unreal-engine', 'usability-testing', 'user-stories', 'vba', 'vbnet', 'vector-search', 'version-control', 'vertex-ai', 'virtualization', 'visio', 'visualforce', 'vite', 'vmware', 'voip', 'vue', 'vulnerability-scanning', 'weaviate', 'web3', 'weblogic', 'webpack', 'websockets', 'wifi', 'windows-server', 'workday', 'xdr', 'xero', 'xgboost', 'xslt', 'yaml', 'yardi', 'zabbix', 'zapier', 'zero-trust', 'zeromq', 'zig', 'zoominfo'];
