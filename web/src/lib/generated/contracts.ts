...
export const ROLE_ALIASES = {
  '3d_artist': ['2d artist', '3d artist', 'character artist', 'environment artist'],
  'account_executive': ['account executive'],
  'account_manager': ['account manager'],
  'accountant': ['accountant'],
  ...
  'copywriter': ['copywriter'],
  'creative': ['2d artist', '3d artist', 'animator', 'audio designer', 'audio engineer', 'character artist', 'concept artist', 'environment artist', 'illustrator', 'motion graphics artist', 'photo editor', 'photographer', 'sound designer', 'sound engineer', 'storyboard artist', 'technical artist', 'vfx artist', 'video editor', 'video producer', 'videographer'],
  'creative_director': ['creative director'],
  'customer_engineer': ['customer engineer'],
  ...
  'sound_designer': ['audio designer', 'audio engineer', 'sound designer', 'sound engineer'],
  'sre': ['site reliability', 'sre'],
  'staff': ['staff'],
  'staff_engineer': ['staff engineer'],
  'storyboard_artist': ['storyboard artist', 'vfx artist'],
