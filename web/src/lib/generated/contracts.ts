...
export const FACET_ALIASES = {
  ...
  'occupational_safety': ['ehs', 'health & safety', 'health and safety', 'hse', 'hse risk', 'hseq', 'hsse', 'industrial hygiene', 'industrial hygienist', 'qhse', 'risk control consultant', 'safety advisor', 'safety coordinator', 'safety director', 'safety engineer', 'safety lead', 'safety manager', 'safety officer', 'safety risk', 'safety specialist', 'safety supervisor', 'safety technician', 'she advisor', 'she coordinator', 'she manager', 'she officer', 'she specialist', 'sheq', 'shes', 'охрана труда', 'охране труда'],
