...
export const SOURCE_VALUES = ['telegram', 'workatastartup', 'remoteok', 'arc', 'ashby', 'ashbygraphql', 'bamboohr', 'breezy', 'eightfold', 'gem', 'globalpayments', 'greenhouse', 'gupy', 'huntflow', 'icims', 'jazzhr', 'jibe', 'jobstash', 'join', 'lever', 'oracle', 'personio', 'phenom', 'pinpoint', 'radancy', 'recruitee', 'rippling', 'smartrecruiters', 'successfactors', 'teamtailor', 'tecla', 'workable', 'workday', 'wpyoast'] as const;
