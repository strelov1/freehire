...
export const FACET_ALIASES = {
  ...
  'network_engineering': ['hálózati mérnök', 'hálózati rendszermérnök', 'network administrator', 'network design engineer', 'network engineer', 'network engineering', 'network specialist', 'network technician', 'сетевой администратор', 'сетевой инженер'],
  ...
  'qa': ['automata tesztelő', 'design engineer in test', 'manuális tesztelő', 'qa', 'quality assurance', 'sdet', 'software design engineer in test', 'szoftvertesztelő', 'test automation', 'test engineer', 'tester', 'tesztmenedzser', 'тестирование', 'тестировщик'],
