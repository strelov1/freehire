...
export const FACET_ALIASES = {
  ...
  'network_engineering': ['hálózati mérnök', 'hálózati rendszermérnök', 'hálózatüzemeltető', 'network administrator', 'network design engineer', 'network engineer', 'network engineering', 'network specialist', 'network technician', 'сетевой администратор', 'сетевой инженер'],
  ...
  'qa': ['design engineer in test', 'qa', 'quality assurance', 'sdet', 'software design engineer in test', 'szoftvertesztelő', 'test automation', 'test engineer', 'tester', 'tesztelő', 'tesztmenedzser', 'тестирование', 'тестировщик'],
