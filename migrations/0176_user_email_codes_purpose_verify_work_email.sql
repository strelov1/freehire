...
-- squawk-ignore constraint-missing-not-valid: table is small/short-lived (see above), so
-- the table-scan lock this rule warns about is effectively instant here.
ALTER TABLE public.user_email_codes
