-- Rolling FORWARD again after 0132_pro_until_sources.down.sql. Read that file first.
--
-- This is not migrations/0132_pro_until_sources.sql run a second time, and reaching for that
...
-- is left.
--
--   psql "$DATABASE_URL" -f deploy/rollback/0132_pro_until_sources.reapply.sql
--
